...
\part[Предисловие к первому изданию]{\large ПРЕДИСЛОВИЕ К ПЕРВОМУ ИЗДАНИЮ}
\thispagestyle{empty}
\input{002_predislovie.tex}

\part[Предисловие ко второму изданию]{\large ПРЕДИСЛОВИЕ КО ВТОРОМУ ИЗДАНИЮ}
\thispagestyle{empty}
\input{003_predislovie.tex}

\part[Введение]{\large ВВЕДЕНИЕ}
\thispagestyle{empty}
...
\hegchapter[Вторая глава. Наличное бытие]{Вторая глава}{НАЛИЧНОЕ БЫТИЕ}
\input{112_nalichnoe_bytie.tex}

\hegchapter[Третья глава. Для-себя-бытие]{Третья глава}{ДЛЯ-СЕБЯ-БЫТИЕ}
...
\hegchapter[Вторая глава. Определенное количество]{Вторая глава}{ОПРЕДЕЛЕННОЕ КОЛИЧЕСТВО}
\input{122_opredelyonnoe_kolichestvo.tex}

\hegchapter[Третья глава. Количественное отношение]{Третья глава}{КОЛИЧЕСТВЕННОЕ ОТНОШЕНИЕ}
\input{123_kolichestvennoe_otnoshenie.tex}


\part[Третий отдел. Мера]{{\em\mdseries Третий отдел}\\МEРА}
% {Первая глава. Специфическое количество.}
\input{131_specificheskoe_kolichestvo.tex}

\hegchapter[Вторая глава. Реальная мера]{Вторая глава}{РЕАЛЬНАЯ МЕРА}
\input{132_realnaya_mera.tex}

\hegchapter[Третья глава. Становление Сущности]{Третья глава}{СТАНОВЛЕНИЕ СУЩНОСТИ}
